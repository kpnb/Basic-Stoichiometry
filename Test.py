...
calcType = raw_input("Please enter the type of calculation: ")

if calcType == "grams to moles":
    elementName = raw_input("Please enter the element name: ")
    grams = raw_input("Please enter the grams: ")
    if gramsToMoles(grams, elementName) == 1:
        print "There is 1 mole of " + elementName + " in " + grams + " grams of " + elementName
    else:
        print "There are " + str(gramsToMoles(grams, elementName)) + " moles of " + elementName + " in " + grams + " grams of " + elementName
elif calcType == "moles to grams":
    elementName = raw_input("Please enter the element name: ")
    moles = raw_input("Please enter the moles: ")
    if molesToGrams(moles, elementName) == 1:
        print "There is 1 gram of " + elementName + "in " + moles + " moles of " + elementName
    else:
        print "There are " + str(molesToGrams(moles, elementName)) + " grams of " + elementName + " in " + moles + " moles of " + elementName
elif calcType == "grams to molecules":
    elementName = raw_input("Please enter the element name: ")
    grams = raw_input("Please enter the grams: ")
    if gramsToMolecules(grams, elementName) == 1:
        print "There is 1 molecule in " + grams + " grams of " + elementName
    else:
        print "There are " + str(gramsToMolecules(grams, elementName)) + " molecules in " + grams + " grams of " + elementName
elif calcType == "molecules to grams":
    elementName = raw_input("Please enter the element name: ")
    molecules = raw_input("Please enter the molecules: ")
    if moleculesToGrams(molecule, elementName) == 1:
        print "There is 1 gram in " + elementName + "in " + grams + " grams of " + elementName
    else:
        print "There are " + str(moleculesToGrams(molecule, elementName)) + " grams of " + elementName + " in " + molecules + " molecules of " + elementName
#elif calcType == "moles to molecules":
 #   moles = raw_input("Please enter the moles: ")
  #  print "There are " + str(molesToMolecules(moles)) + " molecules of " + elementName + " in " + moles + " moles"
#elif calcType == "molecules to moles":
 #   molecules = raw_input("Please enter the molecules: ")
  #  print "There are " + str(moleculesToMoles(molecules)) + " moles in " + grams + " grams"